...
public class MatrizConversion {
	...
	public MatrizConversion(){
		...
		listaPares.add(new Par(5,24,"0",2044,1707));
		listaPares.add(new Par(5,30,"1",1781,1859));
		listaPares.add(new Par(5,36,"2",1847,1809));
		listaPares.add(new Par(5,42,"3",1889,1771));
		listaPares.add(new Par(5,48,"4",1685,2004));
		listaPares.add(new Par(11,24,"5",1907,1637));
		listaPares.add(new Par(11,30,"6",1720,1798));
		listaPares.add(new Par(11,36,"7",1690,1777));
		listaPares.add(new Par(11,42,"8",1644,1832));
		listaPares.add(new Par(11,48,"9",1583,1925));
		listaPares.add(new Par(17,24,"10",1793,1598));
		listaPares.add(new Par(17,30,"11",1686,1651));
		listaPares.add(new Par(17,36,"12",1595,1727));
		listaPares.add(new Par(17,42,"13",1534,1776));
		listaPares.add(new Par(17,48,"14",1461,1863));
		listaPares.add(new Par(23,24,"15",1685,1551));
		listaPares.add(new Par(23,30,"16",1603,1619));
		listaPares.add(new Par(23,36,"17",1506,1668));
		listaPares.add(new Par(23,42,"18",1451,1714));
		listaPares.add(new Par(23,48,"19",1376,1760));
		listaPares.add(new Par(29,24,"20",1597,1490));
		listaPares.add(new Par(29,30,"21",1525,1539));
		listaPares.add(new Par(29,36,"22",1402,1604));
		listaPares.add(new Par(29,42,"23",1329,1638));
		listaPares.add(new Par(29,48,"24",1285,1676));
		listaPares.add(new Par(35,24,"25",1531,1423));
		listaPares.add(new Par(35,30,"26",1470,1467));
		listaPares.add(new Par(35,36,"27",1373,1520));
		listaPares.add(new Par(35,42,"28",1268,1570));
		listaPares.add(new Par(35,48,"29",1191,1592));
		listaPares.add(new Par(41,24,"30",1470,1357));
		listaPares.add(new Par(41,30,"31",1385,1398));
		listaPares.add(new Par(41,36,"32",1284,1449));
		listaPares.add(new Par(41,42,"33",1189,1477));
		listaPares.add(new Par(41,48,"34",1096,1492));
		listaPares.add(new Par(47,24,"35",1421,1277));
		listaPares.add(new Par(47,30,"36",1328,1322));
		listaPares.add(new Par(47,36,"37",1224,1362));
		listaPares.add(new Par(47,42,"38",1131,1394));
		listaPares.add(new Par(47,48,"39",1021,1403));
		listaPares.add(new Par(53,24,"40",1377,1191));
		listaPares.add(new Par(53,30,"41",1286,1232));
		listaPares.add(new Par(53,36,"42",1168,1279));
		listaPares.add(new Par(53,42,"43",1064,1303));
		listaPares.add(new Par(53,48,"44",966,1318));
		listaPares.add(new Par(59,24,"45",1348,1092));
		listaPares.add(new Par(59,30,"46",1238,1142));
		listaPares.add(new Par(59,36,"47",1124,1197));
		listaPares.add(new Par(59,42,"48",1022,1223));
		listaPares.add(new Par(59,48,"49",911,1240));
		listaPares.add(new Par(65,24,"50",1331,981));
		listaPares.add(new Par(65,30,"51",1214,1053));
		listaPares.add(new Par(65,36,"52",1109,1097));
		listaPares.add(new Par(65,42,"53",993,1127));
		listaPares.add(new Par(65,48,"54",888,1154));
